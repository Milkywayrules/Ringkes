        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Total shortened : <?php echo count($content['totUrl']) ?> URL(s)</h6>
            </div>
            <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td width='15%' align='center'>
                        <div class="row justify-content-center">
                          <a href=<?php echo current_url() . "/detail/{$row->id}" ?> class="btn-sm btn-primary text-decoration-none my-1 mx-1">Detail</a>
                          <a href=<?php echo current_url() . "/edit/{$row->id}" ?> class="btn-sm btn-info text-decoration-none my-1">Edit</a>
                        </div>
                      </td>
                    </tr>
                    <?php $no++; endforeach; ?>
